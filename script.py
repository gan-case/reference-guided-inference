...
def download_cp():
    url = "https://drive.google.com/uc?id=1XyumF6_fdAxFmxpFcmPf-q84LU_22EMC"
    out = "checkpoints/sam_ffhq_aging.pt"
    url_id = "1XyumF6_fdAxFmxpFcmPf-q84LU_22EMC"
    
    # gdd.download_file_from_google_drive(file_id='1XyumF6_fdAxFmxpFcmPf-q84LU_22EMC', dest_path=out)
    
    gdown.download(id=url_id, output=out, quiet=False)
